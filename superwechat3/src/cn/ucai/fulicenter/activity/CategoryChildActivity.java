...
//        Log.e("main","name="+name);
        ...
        mSwipeRefreshLayout= (SwipeRefreshLayout) findViewById(R.id.srl_child_category);
        ...
        mRecyclerView= (RecyclerView)findViewById(R.id.rv_child_category);
